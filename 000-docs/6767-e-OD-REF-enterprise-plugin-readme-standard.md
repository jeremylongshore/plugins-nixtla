...
│
├── plugins/                               # Actual plugin source code
│   └── [plugin-slug]/
│       ├── .claude-plugin/
│       │   └── plugin.json
│       ├── commands/
...
|--------|----------|--------|------|
| [Baseline Lab](plugins/baseline-lab/) | Efficiency | Faster debugging | [BC](000-docs/plugins/baseline-lab/01-BUSINESS-CASE.md) · [PRD](000-docs/plugins/baseline-lab/02-PRD.md) · [Arch](000-docs/plugins/baseline-lab/03-ARCHITECTURE.md) · [UJ](000-docs/plugins/baseline-lab/04-USER-JOURNEY.md) · [Tech](000-docs/plugins/baseline-lab/05-TECHNICAL-SPEC.md) |
```
...
\`\`\`bash
git clone [repo-url]
cd [repo]/plugins/[working-plugin]
...
See individual plugin [Architecture docs](000-docs/plugins/) for details.
```
...
When a plugin moves from Idea (💡) to Specified (📋), create all 6 docs in `000-docs/plugins/[plugin-slug]/`.
...
1. Create folder: `000-docs/plugins/[plugin-slug]/`
2. Create all 6 documents following the standards above
3. Create plugin code folder: `plugins/[plugin-slug]/` with basic structure
...
```markdown
| [Cost Optimizer](plugins/cost-optimizer/) | Efficiency | 30-50% API cost reduction | [BC](000-docs/plugins/cost-optimizer/01-BUSINESS-CASE.md) · [PRD](000-docs/plugins/cost-optimizer/02-PRD.md) · [Arch](000-docs/plugins/cost-optimizer/03-ARCHITECTURE.md) · [UJ](000-docs/plugins/cost-optimizer/04-USER-JOURNEY.md) · [Tech](000-docs/plugins/cost-optimizer/05-TECHNICAL-SPEC.md) |
```
