...
if __name__ == "__main__":
    ...
    parser.add_argument('--mase_threshold', type=float, default=0.2, help='Threshold for acceptable MASE deviation (default: 0.2).')
    parser.add_argument('--smape_threshold', type=float, default=0.2, help='Threshold for acceptable sMAPE deviation (default: 0.2).')
