...
from .dimensions import DIMENSION_WEIGHTS, score_all_dimensions
from .llm_judge import run_llm_evaluation
from .ranking import category_rankings, rank_skills, run_round_robin
from .stats import bootstrap_ci, weighted_composite, wilson_score_ci
...
class DeepEvalEngine:
    ...
    def summary(self, results: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "llm_available": any(
                r.get("layers", {}).get("llm", {}).get("available", False) for r in results
            ),
        }
