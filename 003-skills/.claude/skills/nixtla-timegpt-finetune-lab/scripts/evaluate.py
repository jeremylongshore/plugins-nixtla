...
Metrics:
  ...
  MASE:  Mean Absolute Scaled Error (relative to naive forecast)
    ...
    parser.add_argument('--comparison',
                       help='Comparison results CSV (from compare_finetuned.py)')
    parser.add_argument('--train', help='Training data CSV (for MASE calculation)')
    parser.add_argument('--seasonality', type=int, default=1,
                       help='Seasonal period for MASE (default: 1)')

    # Output options
    parser.add_argument('--output',
                       help='Output CSV path (default: forecasting/results/evaluation.csv)')
    parser.add_argument('--model-name', default='TimeGPT',
