...
Environment Variables:
  NIXTLA_API_KEY: Required. Get from https://dashboard.nixtla.io
    ...
    parser.add_argument('--test', required=True,
                       help='Test data CSV path (with actual values)')
    parser.add_argument('--finetune-id',
                       help='Fine-tuned model ID (or load from artifacts)')
    ...
    parser.add_argument('--freq', default='D',
                       help='Data frequency (default: D)')
    parser.add_argument('--output',
                       default='forecasting/results/comparison_metrics.csv',
